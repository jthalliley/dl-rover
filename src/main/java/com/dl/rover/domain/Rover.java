...
public class Rover {
    ...
    public void move(final Grid grid, final MovingDirection movingDirection) throws ObstacleInTheWayException {
        ...
        if (grid.hasObstacle(newPoint)) {
            ...
            throw new ObstacleInTheWayException(newPoint);
        }
    ...
    public void executeCommands(final char[] commands, final Grid grid)
        throws InvalidCommandException, ObstacleInTheWayException, OffTheGridException {

        for (char command : commands) {
            MovingDirection movingDirection = MovingDirection.valueOf(command);

            System.out.println("Attempting to move " + movingDirection.display() + " from " + getLocation() + " while facing " + getFacingDirection());
            ...
            System.out.println("Now at " + getLocation() + " facing " + getFacingDirection());
        }
